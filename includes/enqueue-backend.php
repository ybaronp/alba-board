...
/**
 * Enqueue administrative scripts and styles for the Alba Board visual page.
 */
function alba_board_enqueue_admin_assets($hook) {
    // Only load on the specific visual board page to optimize performance
    ...
    // Modern Date Picker: Flatpickr (CSS & JS)
